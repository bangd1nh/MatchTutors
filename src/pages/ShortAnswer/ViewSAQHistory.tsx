        ...
        <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                    Kết quả chi tiết của bài tự luận: {submissionData.quizId?.title || "Bài tự luận"}
                </p>
            </div>
            ...
            <Card className="border-l-4 border-l-orange-500">
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <Badge
                            variant={getScoreBadgeVariant(submissionData.score, totalPossiblePoints)}
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="text-center p-3 bg-purple-50 dark:bg-purple-950/20 rounded-lg border border-purple-200 dark:border-purple-800">
                            ...
                            <div className={`text-2xl font-bold ${getScoreColor(accuracy, 100)}`}>
                                {accuracy}%
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span>Học sinh: {submissionData.studentId?.name || "N/A"}</span>
                        </div>
                    ...
                    {submissionData.quizSnapshot?.settings && (
                        <div className="bg-muted/50 p-3 rounded-lg">
                            ...
                            <div className="flex flex-wrap gap-2 text-xs">
                                ...
                                <Badge variant="outline">
                                    {submissionData.quizSnapshot.settings.showCorrectAnswersAfterSubmit
                                ...
                                {submissionData.quizSnapshot.settings.timeLimitMinutes && (
                                    <Badge variant="outline">
                                        ...
                                        Giới hạn: {submissionData.quizSnapshot.settings.timeLimitMinutes} phút
                                    </Badge>
                                )}
                            </div>
                        </div>
            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    {submissionData.answers.map((answer: any, index: number) => (
                        <div
                            key={`question-${index}`}
                            className={`p-4 rounded-lg border-l-4 transition-colors ${answer.isCorrect
                        ...
                        >
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex-1">
                                    ...
                                    <h4 className="font-medium text-foreground mb-2">
                                        {answer.questionId?.questionText || "Câu hỏi tự luận"}
                                    </h4>
                                </div>
                            </div>
                                ...
                                <div className="space-y-2 mb-3">
                                    ...
                                    <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded p-3">
                                        <div className="space-y-1">
                                            {answer.questionId.acceptedAnswers.map((acceptedAnswer: string, accIndex: number) => (
                                                <div
                                                    key={accIndex}
                            ...
                            <div className="mt-3 flex items-center justify-between pt-2 border-t">
                                <div className="text-sm text-muted-foreground">
                                    ...
                                    {answer.obtainedPoints || 0}/{answer.questionId?.points || 0}
                                </div>
                                {answer.isCorrect && (
                ...
                <Button
                    onClick={() => {
                        if (submissionData.quizId?._id) {
                            navigate(`/student/doSAQ?shortAnswerId=${submissionData.quizId._id}`);
                        }
                    }}
                >
